...
wip_and_task_allowed_status_transition = {
    ...
    'delivery_order_created': [
        'pending', 'courier_pickup_requested', 'pick_up_by_courier', 'in_transit', 'delivering', 'detained', 'signed', 
        'problem_shipment_being_processed', 'returned_shipment', 'close_by_exception', 'cancelled', 'done'
    ],
    'courier_pickup_requested': [
        'pending', 'delivery_order_created', 'pick_up_by_courier', 'in_transit', 'delivering', 'detained', 'signed', 
        'problem_shipment_being_processed', 'returned_shipment', 'close_by_exception', 'cancelled', 'done'
    ],
    'pick_up_by_courier': [
        'pending', 'delivery_order_created', 'courier_pickup_requested', 'in_transit', 'delivering', 'detained', 'signed', 
        'problem_shipment_being_processed', 'returned_shipment', 'close_by_exception', 'cancelled', 'done'
    ],
    'in_transit': [
        'pending', 'delivery_order_created', 'courier_pickup_requested', 'pick_up_by_courier', 'delivering', 'detained', 'signed', 
        'problem_shipment_being_processed', 'returned_shipment', 'close_by_exception', 'cancelled', 'done'
    ],
    'delivering': [
        'pending', 'delivery_order_created', 'courier_pickup_requested', 'pick_up_by_courier', 'in_transit', 'detained', 'signed', 
        'problem_shipment_being_processed', 'returned_shipment', 'close_by_exception', 'cancelled', 'done'
    ],
    'detained': [
        'pending', 'delivery_order_created', 'courier_pickup_requested', 'pick_up_by_courier', 'in_transit', 'delivering', 'signed', 
        'problem_shipment_being_processed', 'returned_shipment', 'close_by_exception', 'cancelled', 'done'
    ],
    # 'signed' is a terminal state and has no further transitions.
    'signed': [],
    'problem_shipment_being_processed': [
        'pending', 'delivery_order_created', 'courier_pickup_requested', 'pick_up_by_courier', 'in_transit', 'delivering', 'detained', 'signed', 
